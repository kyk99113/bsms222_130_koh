...
**ANSWER**:
```{r}
poll2 <- polls %>% mutate(x_hat = (d_hat+1)/2, se_hat = 2*sqrt(x_hat*(1-x_hat)/samplesize),
...
This is a slightly different p-value than that with the Chi-square test. This is because we are using a different asymptotic approximation to the null _Generalized Linear Models_ book by McCullagh and Nelder.
